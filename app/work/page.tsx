    ...
    <div className="container mx-auto px-4 py-8 md:py-12 space-y-16 md:space-y-20">
      ...
      <section>
        <div className="mb-8">
          <VideoPlayer
            ...
            showMuteButton
          />
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">WORKS</h1>
      ...
      <section>
        <VideoPlayer
          ...
          showMuteButton
        />
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 md:mb-8">Audio visual</h2>
      ...
      <section>
        <VideoPlayer
          ...
          showMuteButton
        />
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 md:mb-8">Interlinked</h2>
        <div className="cursor-pointer">
          <VideoPlayer
