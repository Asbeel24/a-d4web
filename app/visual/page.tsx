...
const videos = [
  ...
  { id: 3, title: '808Day', type: 'audio-visual', src: '/media/videos/4d9fdb1f75daa02546b0b0a3bbac0c5c.mp4' },
  { id: 4, title: 'Interlinked', type: 'audio-visual', src: '/media/videos/8789_raw (1).mp4' },
  { id: 5, title: 'Binance Visualization', type: 'audio-visual', src: '/media/videos/Binance Visualization.mp4' },
  { id: 6, title: 'Untitled', type: 'audio-visual', src: '/media/videos/untitled (1).mov' },
];
